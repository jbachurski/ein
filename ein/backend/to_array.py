        ...
        match expr:
            case axial_calculus.Const(array):
                return Axial.of_normal(
                    array_calculus.Const(array), expr.type.array_type.kind
                )
            case axial_calculus.Range(index, size_):
                size = go(size_, index_vars)
                return Axial(
                    [index], array_calculus.Range(size.array), expr.type.array_type.kind
                )
            case axial_calculus.Var(var, var_type):
                return Axial.of_normal(
                    array_calculus.Var(var, var_type.rank), expr.type.array_type.kind
                )
